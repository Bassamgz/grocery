...
namespace Services
{
    ...
    internal partial class Order : object
    {
    ...
    internal interface IOrderService
    {
        ...
        System.Threading.Tasks.Task<string> PlaceAsync(Services.Order order);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("dotnet-svcutil", "0.5.0.0")]
    internal interface IOrderServiceChannel : Services.IOrderService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("dotnet-svcutil", "0.5.0.0")]
    internal partial class OrderServiceClient : System.ServiceModel.ClientBase<Services.IOrderService>, Services.IOrderService
    {
    ...
    static partial void ConfigureEndpoint(System.ServiceModel.Description.ServiceEndpoint serviceEndpoint, System.ServiceModel.Description.ClientCredentials clientCredentials);
        ...
        public System.Threading.Tasks.Task<string> PlaceAsync(Services.Order order)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IOrderService))
            {
                return new System.ServiceModel.EndpointAddress("http://apoteketuppgift1.cloudapp.net:8080/OrderService.svc");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
